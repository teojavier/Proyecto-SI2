...
<body>
    ...
    <div>
        <div class="px-32 py-20 bg-gray-100 grid  gap-10">
            ...
            <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div
                    ...
                    <div class="py-4 px-4 bg-white">
                        <h3 class="text-lg font-semibold text-gray-600">Apple MacBook Pro M1 13.3&quot; Silver 16GB/512GB
                            (MYDC2FN/A-16GB)</h3>
            ...
            <div
                class="max-w-xs rounded-lg overflow-hidden border-gray-600 hover:border-yellow-400 hover:bg-yellow-400 border-4">
                <div>
                    <img src="https://media.ldlc.com/r1600/ld/products/00/05/82/02/LD0005820208_1.jpg" alt="" />
                </div>
                <div class="py-4 px-4">
                    ...
                    <p class="mt-4 text-lg font-thin">$ 2400</p>
                    <button
                        class="border-2 border-gray-600 px-6 rounded-lg transform transition duration-500 hover:scale-110">hola</button>
                </div>
            </div>

            <div
                class="max-w-xs rounded-md overflow-hidden shadow-md hover:scale-105 transition duration-500 cursor-pointer">
                <div>
                    <img src="https://media.ldlc.com/r1600/ld/products/00/05/82/02/LD0005820208_1.jpg" alt="" />
                </div>
                <div class="py-4 px-4 bg-white">
